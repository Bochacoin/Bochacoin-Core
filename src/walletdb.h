...
public:
    ...
    bool WriteZBOCHASeed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadZBOCHASeed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadZBOCHASeed_deprecated(uint256& seed);
    bool EraseZBOCHASeed();
    bool EraseZBOCHASeed_deprecated();

    bool WriteZBOCHACount(const uint32_t& nCount);
    bool ReadZBOCHACount(uint32_t& nCount);
