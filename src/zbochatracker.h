...
#ifndef Bochacoin_ZBOCHATRACKER_H
#define Bochacoin_ZBOCHATRACKER_H
...
public:
    CzBOCHATracker(std::string strWalletFile);
    ~CzBOCHATracker();
...
#endif //Bochacoin_ZBOCHATRACKER_H
