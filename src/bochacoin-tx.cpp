...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Bochacoin Core bochacoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bochacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bochacoin transaction") + "\n" +
                               "  bochacoin-tx [options] -create [commands]   " + _("Create hex-encoded bochacoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bochacoin transaction
