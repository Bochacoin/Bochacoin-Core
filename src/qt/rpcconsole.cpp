                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBOCHAPathCustom = GetArg("-zbochabackuppath", "");
    ...
    if(!strzBOCHAPathCustom.empty()) {
        ui->wallet_customzbochabackuppath->setText(QString::fromStdString(strzBOCHAPathCustom));
        ui->wallet_customzbochabackuppath_label->setVisible(true);
        ui->wallet_customzbochabackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBOCHAPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Bochacoin RPC console.") + "<br>" +
