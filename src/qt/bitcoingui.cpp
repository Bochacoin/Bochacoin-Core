                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Bochacoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bochacoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bochacoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBOCHA"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Bochacoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bochacoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bochacoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bochacoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bochacoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Bochacoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Bochacoin Core help message to get a list with possible Bochacoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Bochacoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bochacoin network", "", count));
}
...
{
    QString strTitle = tr("Bochacoin Core"); // default title
