...
/** Utility functions used by the Bochacoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Bochacoin addresses in monospace font
...
// Parse "bochacoin:" URI into recipient object, return true on successful parsing
