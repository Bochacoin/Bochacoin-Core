...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zbochaTracker->HasMintTx(hash))) {
            //zBOCHA stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZBOCHA;
...
bool IsZBOCHAType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZBOCHA:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZBOCHA || type == TransactionRecord::MNReward) {
