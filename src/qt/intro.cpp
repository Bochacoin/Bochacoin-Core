...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Bochacoin Core"),
     ...
     * override -datadir in the bochacoin.conf file in the default data directory
     * (to be consistent with bochacoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
