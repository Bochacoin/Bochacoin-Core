...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextBtc = tr("");
    QString copyrightTextDash = tr("");
    QString copyrightTextPIVX = tr("");
    QString copyrightTextBochacoin = tr("");
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextBochacoin);
