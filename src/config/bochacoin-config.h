/* src/config/bochacoin-config.h.  Generated from bochacoin-config.h.in by configure.  */
/* src/config/bochacoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BOCHA_CONFIG_H

#define BOCHA_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.bochacoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Bochacoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bochacoin Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bochacoin"
