...
#ifndef Bochacoin_STAKEINPUT_H
#define Bochacoin_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZBOCHA() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zBOCHAStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zbocha, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZBOCHA() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZBOCHA() override { return false; }
};


#endif //Bochacoin_STAKEINPUT_H
