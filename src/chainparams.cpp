...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00006cb8107429b0f58519665d69b42102c3c20c78c32742ec46f3f1b4ecd458"))
...
public:
    CMainParams()
    {
        ...
        nEnforceNewSporkKey = 1562008015; //!> Sporks signed after (GMT): Tuesday, May 1, 2018 7:00:00 AM GMT must use the new spork key
        nRejectOldSporkKey = 1562008015; //!> Fully reject old spork key after (GMT): Friday, June 1, 2018 12:00:00 AM


        const char* pszTimestamp = "Blocksonchain is a minimum guaranteed price aka MGP";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1562008015;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 0x1640f;



        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00006cb8107429b0f58519665d69b42102c3c20c78c32742ec46f3f1b4ecd458"));
        assert(genesis.hashMerkleRoot == uint256("0xb88a8fee2f632c66dd7f6ad949a8e5e3c039a702fffb53a8fbfedda9e259e158"));

        vSeeds.push_back(CDNSSeedData("seed1", "seed1.bochacoin.com"));
        vSeeds.push_back(CDNSSeedData("seed2", "seed2.bochacoin.com"));
        vSeeds.push_back(CDNSSeedData("seed3", "seed3.bochacoin.com"));
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zbocha to be stakable
...
public:
    CTestNetParams()
    {
        ...
        genesis.nNonce = 0x5742;



        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00001173a014512f30c7472dfd1701c23b89fb06d4bdcd4425197c0d271d7fac"));

        vFixedSeeds.clear();
        vSeeds.clear();

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 0); // Testnet bochacoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 1);  // Testnet bochacoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 128);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet bochacoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet bochacoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet bochacoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Bochacoin: 1 day
        nTargetSpacing = 1 * 60;        // Bochacoin: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1551107115;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 0x59d6;



        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 51476;
        assert(hashGenesisBlock == uint256("0x0000e9ff7a10589d5f8fc62321cfa8051147b477d1c48601fd7bedc734a4b616"));
