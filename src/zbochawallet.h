...
#ifndef Bochacoin_ZBOCHAWALLET_H
#define Bochacoin_ZBOCHAWALLET_H
...
public:
    CzBOCHAWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBOCHA(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBOCHA(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //Bochacoin_ZBOCHAWALLET_H
