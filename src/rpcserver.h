...
/**
 * Bochacoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzbochaseed(const UniValue& params, bool fHelp);
extern UniValue getzbochaseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzbocha(const UniValue& params, bool fHelp);
extern UniValue dzbochastate(const UniValue& params, bool fHelp);
