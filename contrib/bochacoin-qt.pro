...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/bochacoin-cli.cpp \
           src/bochacoin-tx.cpp \
           src/bochacoin.cpp \
           src/db.cpp \
           ...
           src/qt/bochacoin.cpp \
           src/qt/bochacoinstrings.cpp \
...
RESOURCES += src/qt/bochacoin.qrc src/qt/bochacoin_locale.qrc

TRANSLATIONS += src/qt/locale/bochacoin_bg.ts \
                src/qt/locale/bochacoin_de.ts \
                src/qt/locale/bochacoin_en.ts \
                src/qt/locale/bochacoin_es.ts \
                src/qt/locale/bochacoin_fi.ts \
                src/qt/locale/bochacoin_fr.ts \
                src/qt/locale/bochacoin_it.ts \
                src/qt/locale/bochacoin_ja.ts \
                src/qt/locale/bochacoin_pl.ts \
                src/qt/locale/bochacoin_pt.ts \
                src/qt/locale/bochacoin_ru.ts \
                src/qt/locale/bochacoin_sk.ts \
                src/qt/locale/bochacoin_sv.ts \
                src/qt/locale/bochacoin_vi.ts \
                src/qt/locale/bochacoin_zh_CN.ts \
                src/qt/locale/bochacoin_zh_TW.ts
