...
In order to support loading of multiple wallets in bochacoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bochacoin.cpp.
...
Changes to bochacoin.cpp
----------------------
bochacoin.cpp is the entry point into bochacoin-qt, and as such, will require some minor modifications to provide hooks for
