...
This mechanism has been integrated into Bitcore-Node-Bochacoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Bochacoin-Project/insight-api-bochacoin#web-socket-api](https://github.com/Bochacoin-Project/insight-api-bochacoin#web-socket-api) 
* API: [https://github.com/Bochacoin-Project/insight-api-bochacoin#swifttx-transactions](https://github.com/Bochacoin-Project/insight-api-bochacoin#swifttx-transactions) 
...
By default, the Bochacoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Bochacoin Core daemon:
