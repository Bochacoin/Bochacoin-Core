...
#   c) node1 mines 32 blocks, so now node 0 has 60001bocha, node 1 has 4250bocha, node2 has none.
#   d) node0 sends 601 bocha to node2, in two transactions (301 bocha, then 300 bocha).
